...
class UserFragment : Fragment()
{
    ...
    private fun initRecyclerView(list: MutableList<UsersItem>) {
        val mLayoutManager = LinearLayoutManager(context)
        val mAdapter = com.example.sportsballistics.ui.dashboard.club.ClubListAdapter(context, list, object :
                com.example.sportsballistics.ui.dashboard.club.ClubListAdapter.OnItemClickListener
        {
            override fun onEditClick(adapterType: Int, user: UsersItem)
            {
                val args = Bundle()
